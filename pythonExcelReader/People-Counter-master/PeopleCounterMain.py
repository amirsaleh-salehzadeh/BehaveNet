...
#     url = 'https://www.youtube.com/watch?v=VBdjLfo344w'
#     vPafy = pafy.new(url)
...
#                 continue
            ...
            cv2.line(frame, (width // 4 +20 , 300), (width // 4 + 140, 300), (250, 0, 1), 2)  # blue line
            cv2.line(frame, (width // 4 +20, 350), (width // 4 + 140, 350), (0, 0, 255), 2)  # red line
